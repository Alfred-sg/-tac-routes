(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["tac-router"] = factory(require("React"));
	else
		root["tac-router"] = factory(root["React"]);
...
var _Symbol$iterator = __webpack_require__(71);
...
var _Object$getPrototypeOf = __webpack_require__(95);

var _Object$setPrototypeOf = __webpack_require__(54);
...
var _Object$create = __webpack_require__(101);
...
var _prop_types_15_7_2_prop_types = __webpack_require__(12);
...
var _gud_1_0_0_gud = __webpack_require__(55);
...
var _path_to_regexp_1_7_0_path_to_regexp = __webpack_require__(38);
...
var _react_is_16_8_6_react_is = __webpack_require__(40);
...
function withRouter(Component) {
  ...
  var C = function C(props) {
    ...
    return external_React_default.a.createElement(react_router_context.Consumer, null, function (context$$1) {
      !context$$1 ?  false ? undefined : tiny_invariant_esm(false) : void 0;
      return external_React_default.a.createElement(Component, _extends({}, remainingProps, context$$1, {
...
function NavLink(_ref) {
  ...
  return external_React_default.a.createElement(react_router_context.Consumer, null, function (context) {
    ...
    return external_React_default.a.createElement(react_router_dom_Link, _extends({
...
// CONCATENATED MODULE: ./src/context/AuthorityContext.tsx

/* harmony default export */ var AuthorityContext = (Object(external_React_["createContext"])(function () {
  return false;
}));
...
function Router_Router(_ref) {
  var _ref$mode = _ref.mode,
      ...
      authority = _ref$authority === void 0 ? function () {
    return true;
  } : _ref$authority,
      children = _ref.children;
  var createHistory = createHistoryMap[mode];
  ...
  window.tac_history = history;
  return external_React_default.a.createElement(react_router_Router, {
    history: history
  }, external_React_default.a.createElement(AuthorityContext.Provider, {
    value: authority
  }, children));
}

/* harmony default export */ var components_Router = (Router_Router);
// EXTERNAL MODULE: ../plutarch/packages/plutarch/node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js
var classCallCheck = __webpack_require__(21);
var classCallCheck_default = /*#__PURE__*/__webpack_require__.n(classCallCheck);

// EXTERNAL MODULE: ../plutarch/packages/plutarch/node_modules/@babel/runtime-corejs2/helpers/createClass.js
var createClass = __webpack_require__(22);
var createClass_default = /*#__PURE__*/__webpack_require__.n(createClass);

// EXTERNAL MODULE: ../plutarch/packages/plutarch/node_modules/@babel/runtime-corejs2/helpers/possibleConstructorReturn.js
var possibleConstructorReturn = __webpack_require__(57);
var possibleConstructorReturn_default = /*#__PURE__*/__webpack_require__.n(possibleConstructorReturn);

// EXTERNAL MODULE: ../plutarch/packages/plutarch/node_modules/@babel/runtime-corejs2/helpers/getPrototypeOf.js
var getPrototypeOf = __webpack_require__(58);
var getPrototypeOf_default = /*#__PURE__*/__webpack_require__.n(getPrototypeOf);

// EXTERNAL MODULE: ../plutarch/packages/plutarch/node_modules/@babel/runtime-corejs2/helpers/inherits.js
var inherits = __webpack_require__(59);
var inherits_default = /*#__PURE__*/__webpack_require__.n(inherits);

// EXTERNAL MODULE: ../plutarch/packages/plutarch/node_modules/@babel/runtime-corejs2/core-js/array/is-array.js
var is_array = __webpack_require__(60);
var is_array_default = /*#__PURE__*/__webpack_require__.n(is_array);

// EXTERNAL MODULE: ../plutarch/packages/plutarch/node_modules/@babel/runtime-corejs2/core-js/object/assign.js
var object_assign = __webpack_require__(13);
var assign_default = /*#__PURE__*/__webpack_require__.n(object_assign);

// CONCATENATED MODULE: ./src/utils/travser.tsx
...
function loop(arr, transform, level) {
  ...
  arr.forEach(function (node) {
    ...
    if (node.children && node.children.length) {
      var newChildren = loop(node.children, transform, level + 1);
      var newNode = transform(assign_default()({}, node, {
        level: level
      }), newChildren);
      if (newNode) result.push(newNode);
    } else {
      var _newNode = transform(assign_default()({}, node, {
        level: level
      }));

      if (_newNode) result.push(_newNode);
    }
  });
  return result;
}
...
function trasver(data, transform) {
...
// CONCATENATED MODULE: ./src/apis/router.tsx
...
function () {
  function Route() {
    classCallCheck_default()(this, Route);
  ...
  createClass_default()(Route, [{
    ...
    value: function addRoutes(routes) {
      ...
      var added = routes.some(function (route) {
        if (!_this.routes.some(function (r) {
          return route.path === r.path;
        })) {
    ...
    value: function subscribe(sub) {
      ...
      return {
        remove: function remove() {
          var index = _this2.subs.indexOf(sub);

          _this2.subs.splice(index, 1);
        }
      };
    }
    /**
    ...
    value: function notify() {
      ...
      // 扁平化
      trasver(this.routes, function (node) {
        _this3.fltternRoutes[node.path] = node;
      });
...
/* harmony default export */ var router = (new router_Route());
...
function renderRoute(route, children) {
  // 重定向
  if (route.redirect) {
    return external_React_default.a.createElement(react_router_Route, {
      key: route.path,
      path: route.path,
      exact: true,
  ...
  return external_React_default.a.createElement(react_router_Route, {
    ...
    render: function render(props) {
      return children ? external_React_default.a.createElement(route.component, props, external_React_default.a.createElement(react_router_Switch, null, children)) : external_React_default.a.createElement(route.component, props);
    }
  });
}
/**
...
/*#__PURE__*/
function (_React$Component) {
  inherits_default()(Routes, _React$Component);

  function Routes() {
    var _this;

    classCallCheck_default()(this, Routes);

    _this = possibleConstructorReturn_default()(this, getPrototypeOf_default()(Routes).apply(this, arguments));
    _this.state = {
      routes: []
    };
    return _this;
  ...
  createClass_default()(Routes, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;

      this.subscriber = router.subscribe(function (routes) {
        _this2.setState({
          routes: routes
        });
      });
    ...
    value: function render() {
      ...
      return external_React_default.a.createElement(AuthorityContext.Consumer, null, function (authority) {
        return external_React_default.a.createElement(react_router_Switch, null, children ? children : trasver(routes, function (route, children) {
          return !route.auth || authority(route.auth) ? renderRoute(route, children) : undefined;
        }));
      });
    }
  }]);
...
// EXTERNAL MODULE: ../plutarch/packages/plutarch/node_modules/@babel/runtime-corejs2/core-js/object/keys.js
var object_keys = __webpack_require__(61);
var keys_default = /*#__PURE__*/__webpack_require__.n(object_keys);

// EXTERNAL MODULE: ../plutarch/packages/plutarch/node_modules/@babel/runtime-corejs2/helpers/typeof.js
var helpers_typeof = __webpack_require__(36);
var typeof_default = /*#__PURE__*/__webpack_require__.n(helpers_typeof);

// EXTERNAL MODULE: ./node_modules/_react-loadable@5.5.0@react-loadable/lib/index.js
var lib = __webpack_require__(39);
var lib_default = /*#__PURE__*/__webpack_require__.n(lib);

// CONCATENATED MODULE: ./src/utils/dynamic.tsx
...
/* harmony default export */ var dynamic = (function (dynamicOptions, options) {
  var loadableFn = lib_default.a;
  var loadableOptions = {
  ...
  } else if (typeof_default()(dynamicOptions) === "object") {
    loadableOptions = assign_default()({}, loadableOptions, dynamicOptions);
  } // Support for passing options,
  // eg: dynamic(import('../hello-world'), {loading: () => <p>Loading something</p>})


  loadableOptions = assign_default()({}, loadableOptions, options); // Support for `render` when using a mapping,
  ...
  if (dynamicOptions.modules) {
    loadableFn = lib_default.a.Map;
    var loadModules = {};
    var modules = dynamicOptions.modules();

    keys_default()(modules).forEach(function (key) {
...
/* concated harmony reexport BrowserRouter */__webpack_require__.d(__webpack_exports__, "BrowserRouter", function() { return react_router_dom_BrowserRouter; });
/* concated harmony reexport HashRouter */__webpack_require__.d(__webpack_exports__, "HashRouter", function() { return react_router_dom_HashRouter; });
/* concated harmony reexport Link */__webpack_require__.d(__webpack_exports__, "Link", function() { return react_router_dom_Link; });
/* concated harmony reexport NavLink */__webpack_require__.d(__webpack_exports__, "NavLink", function() { return NavLink; });
...
/* concated harmony reexport Router */__webpack_require__.d(__webpack_exports__, "Router", function() { return components_Router; });
/* concated harmony reexport Routes */__webpack_require__.d(__webpack_exports__, "Routes", function() { return components_Routes; });
/* concated harmony reexport router */__webpack_require__.d(__webpack_exports__, "router", function() { return router; });
/* concated harmony reexport dynamic */__webpack_require__.d(__webpack_exports__, "dynamic", function() { return dynamic; });
